...
class AuthController {
    login(req, res) {
        ...
        accountModel.login(username, password, (status, result, message, UserID, accessToken, refreshToken, role) => {
            authView.login(res, status, result, message, UserID, accessToken, refreshToken, role)
        })
    }
